...
class ZFJC5(unittest.TestCase):
    ...
    def test_ZFJC5(self):
        ...
        #如果没有找到上面的元素就截取当前页面。
            driver.get_screenshot_as_file("D:\\selenium_use_case\\error_png\\qxnz_ZFJC5.png")
        
        driver.find_element_by_xpath("//*[@id='leftMenu']/li[3]/a").click()
        time.sleep(2)
        driver.find_element_by_xpath("//*[@id='leftMenu']/li[3]/ul/li[2]/a").click()
        time.sleep(2)
        driver.find_element_by_xpath("//*[@id='leftMenu']/li[3]/ul/li[2]/ul/li[5]/a").click()
...
if __name__ == "__main__":
    ...
    suite.addTest(ZFJC5("test_ZFJC5"))
