...
#    print mail_body
    ...
    #发送邮箱用户名/密码
    user = 'zhaoweibo@longruan.com'
    password='Yuanben95'
    #发送邮箱
    sender='zhaoweibo@longruan.com'
    #多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    receiver=['zhaoweibo@longruan.com','2710942389@qq.com']
    #发送邮件主题
    subject = '黔西南州安全云自动化测试报告'
...
#要在163有限设置授权码（即客户端的密码），否则会报535
    msg['From'] = 'zhaoweibo@longruan.com <zhaoweibo@longruan.com>'
...
if __name__=='__main__':   
    ...
    test_dir = 'D:\\selenium_use_case\\test_case'
    #知道测试报告的路径
    test_report_dir='D:\\selenium_use_case\\test_report'
    ...
    runner = HTMLTestRunner(stream=fp,title=u'黔西南州安全云自动化测试报告',description=u'用例执行情况：')
    runner.run(discover)
    #注意：调用函数一定要加括号
    fp.close() 
