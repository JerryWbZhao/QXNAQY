...
class ZHZC4(unittest.TestCase):
    ...
    def test_ZHZC4(self):
        ...
        time.sleep(2)
        driver.find_element_by_xpath("//*[@id='fullName']").send_keys("应急组织机构注册")
        driver.find_element_by_xpath("//*[@id='JGLX']/a").click()
        driver.find_element_by_xpath("//*[@id='JGLX']/ul/li[1]/a").click()
        driver.find_element_by_xpath("//*[@id='shortName']").send_keys("应急")
...
if __name__ == "__main__":
    ...
    suite.addTest(ZHZC4("test_ZHZC4"))
